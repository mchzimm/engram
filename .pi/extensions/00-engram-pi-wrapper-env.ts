 ...
 * Setting it here lets this project use a longer /learn timeout without
 * requiring a manual edit in every local PI install.
 */
process.env.ENGRAM_LEARN_TIMEOUT_MS ??= "15000";
