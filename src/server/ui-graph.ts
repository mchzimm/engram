...
export function buildGraphScript(): string {
  return [
    ...
    "    }",
    "",
    "    const tierSpacing = { project: 42, god: 36, child: 30, edge: 24 };",
    "    const tierRadii = {",
    ...
    "    return base + shellPad + degreePad + haloPad;",
    "  }",
    "",
    ...
    "  const SPRING_LENGTH = Math.max(54, Math.min(120, Math.floor(Math.sqrt(W * H) / 7)));",
    "  const DAMPING = 0.76;",
